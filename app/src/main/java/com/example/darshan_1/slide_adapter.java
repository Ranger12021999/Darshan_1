...
import com.example.darshan_1.R;
...
//    };
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        View view = _inflater.inflate(R.layout.style_card, container, false);
        ConstraintLayout _layoutSlide = view.findViewById(R.id.cons);
        ImageView _imgSlide = view.findViewById(R.id.images);
